...
class WeiboLogin(object):
    ...
    def login(self):
        ...
        datas = self.session.post("https://m.weibo.cn/feed/friends?version=v4")
        datas.encoding = datas.apparent_encoding
        byte_data = pickle.dumps(self.session)
        print(byte_data)
        print(datas.encoding)
        # print(datas.content)

if __name__ == '__main__':
    username = "www.609446687@qq.com"  # 用户名
    password = "17671302700lijie"  # 密码
